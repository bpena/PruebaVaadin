...
import com.bpena.app.MenuLayout;
 ...
 */
@Theme("mytheme")
@Widgetset("com.bpena.MyAppWidgetset")
...
//        }
        ...
        navigator.addView("users", com.bpena.app.user.UserView.class);
    ...
    static boolean isTestMode() {
        return ((VaadinUI) getCurrent()).testMode;
    }
    ...
    @VaadinServletConfiguration(productionMode = false, ui = VaadinUI.class, widgetset = "com.bpena.AppWidgetSet")
